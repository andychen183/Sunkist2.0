...
QVariantList &QGCCorePlugin::settings()
{
    ...
    if(!_p->pGeneral) {
        ...
        _p->pContrlMode = new QGCSettings(tr("ContrlMode"),
            QUrl::fromUserInput("qrc:/qml/ControlMode1.qml"),
            QUrl::fromUserInput("qrc:/res/gear-white.svg"));
        _p->settingsList.append(QVariant::fromValue((QGCSettings*)_p->pContrlMode));
