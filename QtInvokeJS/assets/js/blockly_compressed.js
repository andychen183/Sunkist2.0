...
goog.exportPath_ = function(a, b, c) {
	...
	for(var d; a.length && (d = a.shift());) !a.length && goog.isDef(b) ? c[d] = b : c = c[d] && Object.prototype.hasOwnProperty.call(c, d) ? c[d] : c[d] = {}
};
...
Blockly.Bubble.prototype.resizeMouseDown_ = function(a) {
	...
	Blockly.utils.isRightButton(a) || (Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED), this.workspace_.startDrag(a, new goog.math.Coordinate(this.workspace_.RTL ? -this.width_ : this.width_, this.height_)), Blockly.Bubble.onMouseUpWrapper_ = Blockly.bindEventWithChecks_(document, "mouseup", this, Blockly.Bubble.bubbleMouseUp_), Blockly.Bubble.onMouseMoveWrapper_ = Blockly.bindEventWithChecks_(document, "mousemove",
		this, this.resizeMouseMove_), Blockly.hideChaff());
	a.stopPropagation()
};
...
Blockly.Connection.prototype.toString = function() {
	var a, b = this.sourceBlock_;
	if(b)
		if(b.outputConnection == this) a = "Output Connection of ";
		else if(b.previousConnection == this) a = "Previous Connection of ";
	else if(b.nextConnection == this) a = "Next Connection of ";
	else if(a = goog.array.find(b.inputList, function(a) {
			return a.connection == this
		}, this)) a = 'Input "' + a.name + '" connection on ';
...
Blockly.utils.tokenizeInterpolation_ = function(a, b) {
	...
	for(var e = 0, f = [], g = null, h = 0; h < d.length; h++) {
		...
		0 == e ? "%" == k ? ((k = f.join("")) && c.push(k), f.length = 0, e = 1) : f.push(k) : 1 == e ? "%" == k ? (f.push(k), e = 0) : b && "0" <= k && "9" >= k ? (e = 2, g = k, (k = f.join("")) && c.push(k), f.length = 0) : "{" == k ? e = 3 : (f.push("%", k), e = 0) : 2 == e ? "0" <= k && "9" >= k ? g += k : (c.push(parseInt(g, 10)), h--, e = 0) : 3 == e && ("" == k ? (f.splice(0, 0, "%{"), h--, e = 0) : "}" != k ? f.push(k) : (e = f.join(""), /[a-zA-Z][a-zA-Z0-9_]*/.test(e) ? (k = e.toUpperCase(),
			(k = goog.string.startsWith(k, "BKY_") ? k.substring(4) : null) && k in Blockly.Msg ? (e = Blockly.Msg[k], goog.isString(e) ? Array.prototype.push.apply(c, Blockly.utils.tokenizeInterpolation(e)) : b ? c.push(String(e)) : c.push(e)) : c.push("%{" + e + "}")) : c.push("%{" + e + "}"), e = f.length = 0))
	}(k = f.join("")) && c.push(k);
	d = [];
	...
	for(var g = 0; g < e; g++) {
		...
		if("block" == k || "shadow" == k && !Blockly.Events.recordUndo) {
			k = Blockly.Xml.domToBlock(h,
				b);
			c.push(k.id);
			var m = parseInt(h.getAttribute("x"), 10),
				h = parseInt(h.getAttribute("y"), 10);
			isNaN(m) || isNaN(h) || k.moveBy(b.RTL ? d - m : m, h)
...
Blockly.Xml.appendDomToWorkspace = function(a, b) {
	...
	if(b.hasOwnProperty("scale")) {
		var d = Blockly.BlockSvg.TAB_WIDTH;
		try {
			Blockly.BlockSvg.TAB_WIDTH = 0, c = b.getBlocksBoundingBox()
		} finally {
			Blockly.BlockSvg.TAB_WIDTH = d
		}
	}
	d = Blockly.Xml.domToWorkspace(a, b);
	if(c && c.height) {
		var e, f;
		e = c.y + c.height;
		f = c.x;
		...
		for(c = 0; c < d.length; c++) {
			var k = b.getBlockById(d[c]).getRelativeToSurfaceXY();
			k.y < h && (h = k.y);
			k.x < g && (g = k.x)
		}
		...
		b.RTL && (m = b.getWidth());
		for(c =
			0; c < d.length; c++) b.getBlockById(d[c]).moveBy(b.RTL ? m - f : f, e)
	}
	return d
};
...
Blockly.BlockSvg.prototype.onMouseUp_ = function(a) {
	...
	Blockly.selected && Blockly.highlightedConnection_ && a != Blockly.DELETE_AREA_TOOLBOX ? (Blockly.localConnection_.connect(Blockly.highlightedConnection_), this.rendered && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ :
		Blockly.localConnection_).getSourceBlock().connectionUiEffect(), this.workspace.trashcan && this.workspace.trashcan.close()) : a && !this.getParent() && Blockly.selected.isDeletable() && ((a = this.workspace.trashcan) && goog.Timer.callOnce(a.close, 100, a), Blockly.selected.dispose(!1, !0));
...
Blockly.BlockSvg.prototype.updateCursor_ = function(a, b) {
	...
	if(c && !this.getParent() && Blockly.selected.isDeletable() && !d) return Blockly.Css.setCursor(Blockly.Css.Cursor.DELETE), c == Blockly.DELETE_AREA_TRASH && this.workspace.trashcan && this.workspace.trashcan.setOpen_(!0), !0;
	Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED);
...
Blockly.Variables.flyoutCategory = function(a) {
	...
	c.push(d);
	if(0 < b.length)
		for(Blockly.Blocks.variables_set && (a = Blockly.Blocks.math_change ? 8 : 24, d = '<xml><block type="variables_set" gap="' + a + '"><field name="VAR">' +
			...
			d = Blockly.Xml.textToDom(d).firstChild, c.push(d));
	return c
};
...
Blockly.FlyoutButton.prototype.createDom = function() {
	...
	var a = Blockly.utils.createSvgElement("rect", {
