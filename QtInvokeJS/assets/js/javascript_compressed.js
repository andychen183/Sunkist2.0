...
Blockly.JavaScript.text_print = function(a) {
    ...
    // return "MainWindow.jsInvokeQt();"
};
Blockly.JavaScript.take_off = function(a) {
    var number_take_num = a.getFieldValue('TAKE_NUM');
    return "MainWindow.jsInvokeQt(1," + number_take_num + ");";
};
Blockly.JavaScript['drone_land'] = function(block) {
    return "MainWindow.jsInvokeQt(2, 0);";
};
Blockly.JavaScript['drone_roll'] = function(block) {
  var dropdown_direction = block.getFieldValue('DIRECTION');
  // TODO: Assemble JavaScript into code variable.
  return "MainWindow.jsInvokeQt(3," + dropdown_direction + ");";
};
Blockly.JavaScript['drone_led'] = function(block) {
  var dropdown_direction = block.getFieldValue('LED');
  // TODO: Assemble JavaScript into code variable.
  return "MainWindow.jsInvokeQt(4," + dropdown_direction + ");";
};
Blockly.JavaScript['drone_buzzer'] = function(block) {
  var dropdown_direction = block.getFieldValue('BUZZER');
  // TODO: Assemble JavaScript into code variable.
  return "MainWindow.jsInvokeQt(5," + dropdown_direction + ");";
};
...
Blockly.JavaScript.controls_if = function(a) {
    ...
    c = "",
    d, e;
    do e = Blockly.JavaScript.valueToCode(a, "IF" + b, Blockly.JavaScript.ORDER_NONE) || "false",
